        ...
        do {
            ...
            switch (opcaoSistema) {
                case 1: {
                    ...
                    login.cadastrarUsuario(usuario, email, senha);
                }
                break;
                case 2: {
                    System.out.print("Digite seu nome ou email:");
                    String usuarioOuEmail = sc.nextLine();

                    System.out.print("Digite sua senha:");
                    String senha = sc.nextLine();

                    LoginService loginService = new LoginService(); // Service
                    Login login = loginService.verificarUsuarioOuEmail(usuarioOuEmail, senha); // Retorna Login

                    if (login != null) {
                        System.out.println("Login realizado com sucesso! Bem-vindo, " + login.getUsuario());
