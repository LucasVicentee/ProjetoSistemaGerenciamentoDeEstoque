...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("1 - Para efetuar o login");
        System.out.println("2 - Para cadastrar-se no sistema");
        ...
        switch (opcaoSistema) {
            ...
            break;
            case 2: {
                System.out.println("Digite o seu usuário ou email");
                System.out.print("Usuário ou email: ");
